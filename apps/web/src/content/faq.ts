...
export const faq: Record<Locale, FaqItem[]> = {
  en: [
    { q: 'What changed in the 2026 Uzbek alphabet reform?', a: 'Uzbekistan replaced the 1995 digraphs and apostrophe-letters with single letters: sh→ş, ch→ç, gʻ→ğ, oʻ→ö, and the loanword ts→c. The alphabet now has 28 letters and one apostrophe sign.' },
    ...
    { q: 'Which letters changed?', a: 'Five: sh→ş, ch→ç, gʻ→ğ, oʻ→ö, and ts→c in loanwords.' },
  ...
  uz: [
    { q: '2026-yilgi oʻzbek alifbosi islohotida nima oʻzgardi?', a: 'Oʻzbekiston 1995-yildagi qoʻsh harflar va apostrofli harflarni bitta harfga almashtirdi: sh→ş, ch→ç, gʻ→ğ, oʻ→ö hamda oʻzlashma soʻzlardagi ts→c. Endi alifboda 28 ta harf va bitta tutuq belgisi bor.' },
    ...
    { q: 'Qaysi harflar oʻzgardi?', a: 'Beshta: sh→ş, ch→ç, gʻ→ğ, oʻ→ö va oʻzlashma soʻzlardagi ts→c.' },
  ...
  ru: [
    { q: 'Что изменилось в реформе узбекского алфавита 2026 года?', a: 'Узбекистан заменил диграфы и буквы с апострофом образца 1995 года одиночными буквами: sh→ş, ch→ç, gʻ→ğ, oʻ→ö и ts→c в заимствованиях. Теперь в алфавите 28 букв и один знак апострофа.' },
    ...
    { q: 'Какие буквы изменились?', a: 'Пять: sh→ş, ch→ç, gʻ→ğ, oʻ→ö и ts→c в заимствованиях.' },
