...
export const spotlights: Record<Locale, ReformSpotlight[]> = {
  en: [
    ...
    { id: 'oh', from: 'oʻ', to: 'ö', body: 'The apostrophe-letter oʻ becomes ö.', examples: [['oʻzbek', 'özbek'], ['koʻl', 'köl']] },
  ...
  uz: [
    ...
    { id: 'oh', from: 'oʻ', to: 'ö', body: 'oʻ harfi ö harfiga aylandi.', examples: [['oʻzbek', 'özbek'], ['koʻl', 'köl']] },
  ...
  ru: [
    ...
    { id: 'oh', from: 'oʻ', to: 'ö', body: 'Буква oʻ заменена на ö.', examples: [['oʻzbek', 'özbek'], ['koʻl', 'köl']] },
